    ...
    return (
        <div className="space-y-6">
            <div>
                 ...
                 <Input id="post-title" placeholder="What do you want to ask or share?" className="mt-1 block w-full rounded-md border p-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-ring" />
            </div>

            <div>
            
                <div className="mt-1 min-h-[140px]">
                  <QuillEditor placeholder="Include all the information someone would need to answer your question or understand your post" />
                  </div>
            </div>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <Input type="file" id="post-image" accept="image/*" className="mt-1" aria-label="Upload image" title="Upload image" />
                </div>
            ...
            <div className="space-y-2">
                ...
                <div className="flex gap-2">
                    <input placeholder="Search for a song..." className="flex-1 rounded-md border p-2" />
